  ...
  <div class="py-12 md:py-20 px-4 space-y-20">
    ...
    <section class="max-w-4xl mx-auto text-center space-y-6 pb-20">
      ...
      <div class="flex flex-wrap justify-center gap-3">
        <NuxtLink v-for="fmt in toOptions" :key="fmt" :to="`/convert/${toFormat}-to-${fmt}`" class="px-5 py-2.5 bg-white border border-slate-200 rounded-xl text-sm font-bold text-slate-600 hover:border-blue-500 hover:text-blue-600 transition-all uppercase">
          {{ toFormat }} to {{ fmt }}
        </NuxtLink>
      </div>
    </section>
...
const supportedFormats = ['png', 'jpg', 'webp', 'avif'];
